...
aa1=lglasso(data=postdata,lambda = 0.5,random = FALSE)
aa1
```
...
aa2=lglasso(data=fulldata,lambda = c(0.5,0.1),group = group,random = FALSE)
aa2
```
...
```{r}
aa1=lglasso(data=postdata,lambda = 0.1,random = TRUE)
aa1
```
...
```{r}
aa2=lglasso(data=fulldata,lambda = c(0.5,0.1),group = group,random = TRUE)
aa2
```
