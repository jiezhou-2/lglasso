...
```{r}
bb=CVlglasso(data=data1[,-1],lambda = lambda1,K=8,cores=14,trace = FALSE)
plot(bb)
```
...
```{r}
bb=CVlglasso(data=ddata[,-1],lambda = lambda,group=ddata[,1],K=8,cores=10,trace = FALSE)
plot(bb)
```
