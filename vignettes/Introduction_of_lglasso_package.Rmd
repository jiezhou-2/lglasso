---
title: "Introduction_of_lglasso_package"
...
#### Examples: 
```{r}
a=lglasso(data = sample_data, lambda =  0.7,type = "expFixed",expFix = 1)

##A sub-network
a$preMatrix[1:5,1:5]


a=lglasso(data = sample_data, lambda =  0.7,type = "expFixed",expFix = 2)

##A sub-network
a$preMatrix[1:5,1:5]


a=lglasso(data = sample_data, lambda =  0.7,type = "twoPara")
